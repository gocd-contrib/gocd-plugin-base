...
import static com.github.bdpiparva.plugin.base.dispatcher.authorization.AuthorizationBuilderV2.*;
...
class AuthorizationBuilderV2Test {
    ...
    class AuthConfig {
        ...
        void shouldSupportValidateCall() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_VALIDATE_AUTH_CONFIG);
        ...
        void shouldSupportMetadata() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_GET_AUTH_CONFIG_METADATA);
        ...
        void shouldSupportGetViewCall() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_GET_AUTH_CONFIG_VIEW);
            final RequestDispatcher dispatcher = new AuthorizationBuilderV2()
    ...
    class RoleConfig {
        @Test
        void shouldSupportValidateCall() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_VALIDATE_ROLE_CONFIG);
            final Validator validator = mock(Validator.class);
            when(validator.validate(any())).thenReturn(new ValidationResult());
        ...
        @Test
        void shouldSupportMetadata() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_GET_ROLE_CONFIG_METADATA);
            final RequestDispatcher dispatcher = new AuthorizationBuilderV2()
        ...
        @Test
        void shouldSupportGetViewCall() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_GET_ROLE_CONFIG_VIEW);
            final RequestDispatcher dispatcher = new AuthorizationBuilderV2()
    ...
    void shouldSupportGetUserCall() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_GET_USER_ROLES);
    ...
    void shouldSupportIsValidUserCall() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_IS_VALID_USER);
    ...
    void shouldSupportAuthenticateCall() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_AUTHENTICATE_USER);
    ...
    void shouldSupportSearchUserCall() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_SEARCH_USERS);
    ...
    void shouldSupportGetAccessTokenCall() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_ACCESS_TOKEN);
    ...
    void shouldSupportAuthorizationUrlCall() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_AUTHORIZATION_SERVER_URL);
    ...
    void shouldSupportVerifyConnectionCall() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_VERIFY_CONNECTION);
