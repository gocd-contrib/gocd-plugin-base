...
import static com.github.bdpiparva.plugin.base.dispatcher.elastic.ElasticBuilderV5.*;
...
class ElasticBuilderV5Test {
    ...
    void shouldSupportGetCapabilitiesCall() throws UnhandledRequestTypeException, JSONException {
        when(request.requestName()).thenReturn(REQUEST_CAPABILITIES);
        final RequestDispatcher dispatcher = new ElasticBuilderV5()
    ...
    class ClusterProfile {
        ...
        void shouldSupportMetadata() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_GET_CLUSTER_PROFILE_METADATA);
            final RequestDispatcher dispatcher = new ElasticBuilderV5()
        ...
        void shouldSupportView() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_GET_CLUSTER_PROFILE_VIEW);
            final RequestDispatcher dispatcher = new ElasticBuilderV5()
    ...
    class ElasticAgentProfile {
        @Test
        void shouldSupportMetadata() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_GET_ELASTIC_AGENT_PROFILE_METADATA);
            final RequestDispatcher dispatcher = new ElasticBuilderV5()
        ...
        @Test
        void shouldSupportView() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_GET_ELASTIC_AGENT_PROFILE_VIEW);
            final RequestDispatcher dispatcher = new ElasticBuilderV5()
    ...
    void shouldSupportCreateAgent() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_CREATE_AGENT);
    ...
    void shouldSupportServerPing() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_SERVER_PING);
    ...
    void shouldSupportShouldAssignWork() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_SHOULD_ASSIGN_WORK);
    ...
    class StatusReports {
        ...
        void shouldSupportPluginStatusReport() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_PLUGIN_STATUS_REPORT);
        ...
        void shouldSupportClusterStatusReport() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_CLUSTER_STATUS_REPORT);
        ...
        void shouldSupportAgentStatusReport() throws UnhandledRequestTypeException {
            when(request.requestName()).thenReturn(REQUEST_AGENT_STATUS_REPORT);
    ...
    void shouldSupportJobCompletion() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_JOB_COMPLETION);
    ...
    void shouldSupportMigrateConfiguration() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_MIGRATE_CONFIGURATION);
    ...
    void shouldSupportClusterConfigChanged() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_CLUSTER_PROFILE_CHANGED);
    ...
    void shouldSupportValidateClusterProfile() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_VALIDATE_CLUSTER_PROFILE);
    ...
    void shouldSupportValidateElasticAgentProfile() throws UnhandledRequestTypeException {
        when(request.requestName()).thenReturn(REQUEST_VALIDATE_ELASTIC_AGENT_PROFILE);
        final Validator validator = mock(Validator.class);
        when(validator.validate(any())).thenReturn(new ValidationResult());
